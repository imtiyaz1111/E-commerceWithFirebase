                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p style={{ color: mode === 'dark' ? 'white' : '' }} className="leading-relaxed">This website exceeded my expectations! The design is sleek, the functionality is smooth, and the customer support is outstanding. Highly recommended!</p>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  style={{color: mode === 'dark' ? 'white' : ''}}className="leading-relaxed">The team was professional, efficient, and delivered exactly what I needed. The quality of work was top-notch, and I couldn’t be happier!</p>
                                <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                                <h2 style={{color: mode === 'dark' ? '#ff4162' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Sarah L</h2>
